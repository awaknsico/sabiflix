...
INSERT INTO movies (id, title, alternative_titles, actors, year, country, language, category, synopsis, poster_url, is_active, curation_type, created_by, created_at, updated_at) VALUES
  ...
  ('0190c0de-1000-7000-8000-000000000005', 'Ubuntu', '[]', '["Thuso Mbedu","Sello Maake"]', 2021, 'South Africa', 'Zulu', 'feature', 'After a factory closure divides a township, three neighbours must relearn what it means to belong to one another in this warm, sweeping drama.', '/posters/ubuntu.png', 1, 'admin', '0190c0de-0000-7000-8000-000000000001', unixepoch(), unixepoch());

-- Primary YouTube sources for the seeded catalog -------------------------------
INSERT INTO movie_sources (id, movie_id, youtube_video_id, youtube_channel_name, part_number, is_primary, quality, preview_start_seconds, created_at) VALUES
  ('0190c0de-2000-7000-8000-000000000001', '0190c0de-1000-7000-8000-000000000001', 'aqz-KE-bpKQ', 'SabiFlix Curated', 1, 1, '1080p', 57, unixepoch()),
  ('0190c0de-2000-7000-8000-000000000002', '0190c0de-1000-7000-8000-000000000002', 'YE7VzlLtp-4', 'SabiFlix Curated', 1, 1, '1080p', 94, unixepoch()),
